...
byte WaspSX1272::readRegisterValue(byte address)
{
    byte value = 0x00;
...
void WaspSX1272::clearFlags()
{
	...
	if( _modem == LORA )
	{
		...
		#if (SX1272_debug_mode > 1)
			USB.println(F("## LoRa flags cleared ##"));
		#endif
	}
	else
	{
		...
		#if (SX1272_debug_mode > 1)
			USB.println(F("## FSK flags cleared ##"));
		#endif
	}
}
...
uint8_t WaspSX1272::setLORA()
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'setLORA'"));
	#endif
	...
	{ // LoRa mode
		...
		state = 0;
		#if (SX1272_debug_mode > 1)
			USB.println(F("## LoRa set with success ##"));
			USB.println();
		#endif
	}
	else
	{ // FSK mode
		...
		state = 1;
		#if (SX1272_debug_mode > 1)
			USB.println(F("** There has been an error while setting LoRa **"));
			USB.println();
		#endif
	}
	return state;
...
uint8_t WaspSX1272::setFSK()
{
	...
	{ // FSK mode
		...
		state = 0;
		#if (SX1272_debug_mode > 1)
			USB.println(F("## FSK set with success ##"));
			USB.println();
		#endif
	}
	else
	{ // LoRa mode
		...
		state = 1;
		#if (SX1272_debug_mode > 1)
			USB.println(F("** There has been an error while setting FSK **"));
			USB.println();
		#endif
	}
	return state;
...
uint8_t WaspSX1272::getMode()
{
	...
	#if (SX1272_debug_mode > 1)
	  USB.println();
	  USB.println(F("Starting 'getMode'"));
	#endif
	...
	#if (SX1272_debug_mode > 1)
	  USB.println(F("## Parameters from configuration mode are:"));
...
int8_t WaspSX1272::setMode(uint8_t mode)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'setMode'"));
	#endif
	...
	{
		#if (SX1272_debug_mode > 1)
			USB.print(F("** The indicated mode doesn't exist, "));
			USB.println(F("please select from 1 to 10 **"));
		#endif
	}
	else
	{
	...
	{
		USB.print(F("** There has been an error while configuring mode "));		
		USB.print(mode, DEC);
		USB.println(F(". **"));		
	}
	#endif
...
uint8_t	WaspSX1272::getHeader()
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'getHeader'"));
	#endif
	...
	{ // header is not available in FSK mode
		#if (SX1272_debug_mode > 1)
			USB.println(F("## Notice that FSK mode packets hasn't header ##"));
			USB.println();
		#endif
	}
	else
...
int8_t	WaspSX1272::setHeaderON()
{
  ...
  #if (SX1272_debug_mode > 1)
	  USB.println();
	  USB.println(F("Starting 'setHeaderON'"));
  #endif
  ...
  if( _modem == FSK )
  {
	  ...
	  #if (SX1272_debug_mode > 1)
		  USB.println(F("## FSK mode packets hasn't header ##"));
		  USB.println();
	  #endif
  }
  else
  {
	...
	if( _spreadingFactor == 6 )
	{
		...
		#if (SX1272_debug_mode > 1)
			USB.println(F("## Mandatory implicit header mode with spreading factor = 6 ##"));
		#endif
	}
	else
	{
	...
	{ // checking headerON taking out bit 2 from REG_MODEM_CONFIG1
		...
		if( bitRead(config1, 2) == HEADER_ON )
		{
			...
			_header = HEADER_ON;
			#if (SX1272_debug_mode > 1)
				USB.println(F("## Header has been activated ##"));
				USB.println();
			#endif
		}
		else
...
int8_t	WaspSX1272::setHeaderOFF()
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'setHeaderOFF'"));
	#endif
	...
	else
	{
		...
		{ 
			...
			#if (SX1272_debug_mode > 1)
			    USB.println(F("## Header has been desactivated ##"));
			    USB.println();
			#endif
		}
		else
		{
			state = 1;
			#if (SX1272_debug_mode > 1)
				USB.println(F("** Header hasn't been desactivated ##"));
				USB.println();
			#endif
		}
	}
...
uint8_t	WaspSX1272::getCRC()
{
	...
	{ // LoRa mode
		...
		{ // CRCoff
			_CRC = CRC_OFF;
			#if (SX1272_debug_mode > 1)
				USB.println(F("## CRC is desactivated ##"));
				USB.println();
			#endif
			state = 0;
		}
		...
		{ // CRCon
			_CRC = CRC_ON;
			#if (SX1272_debug_mode > 1)
				USB.println(F("## CRC is activated ##"));
				USB.println();
			#endif
			state = 0;
		}
	...
	if( state != 0 )
	{
		state = 1;
		#if (SX1272_debug_mode > 1)
			USB.println(F("** There has been an error while getting configured CRC **"));
			USB.println();
		#endif
	}
	return state;
...
uint8_t	WaspSX1272::setCRC_ON()
{
  ...
  #if (SX1272_debug_mode > 1)
	  USB.println();
	  USB.println(F("Starting 'setCRC_ON'"));
  #endif
  ...
  { // LORA mode
	...
	{ // take out bit 1 from REG_MODEM_CONFIG1 indicates RxPayloadCrcOn
		...
		_CRC = CRC_ON;
		#if (SX1272_debug_mode > 1)
			USB.println(F("## CRC has been activated ##"));
			USB.println();
		#endif
	}
  }
  ...
  if( state != 0 )
  {
	  state = 1;
	  #if (SX1272_debug_mode > 1)
		  USB.println(F("** There has been an error while setting CRC ON **"));
		  USB.println();
	  #endif
  }
  return state;
...
uint8_t	WaspSX1272::setCRC_OFF()
{
  ...
  #if (SX1272_debug_mode > 1)
	  USB.println();
	  USB.println(F("Starting 'setCRC_OFF'"));
  #endif
  ...
  { // LORA mode
	...
	{ // take out bit 1 from REG_MODEM_CONFIG1 indicates RxPayloadCrcOn
	  ...
	  _CRC = CRC_OFF;
	  #if (SX1272_debug_mode > 1)
		  USB.println(F("## CRC has been desactivated ##"));
		  USB.println();
	  #endif
	}
  }
  ...
  if( state != 0 )
  {
	  state = 1;
	  #if (SX1272_debug_mode > 1)
		  USB.println(F("** There has been an error while setting CRC OFF **"));
		  USB.println();
	  #endif
  }
  return state;
...
int8_t	WaspSX1272::getSF()
{
  ...
  if( _modem == FSK )
  {
	  ...
	  #if (SX1272_debug_mode > 1)
		  USB.println(F("** FSK mode hasn't spreading factor **"));
		  USB.println();
	  #endif
  }
  else
...
uint8_t	WaspSX1272::setSF(uint8_t spr)
{
	...
	if( _modem == FSK )
	{
		/// FSK mode
		#if (SX1272_debug_mode > 1)
			USB.print(F("## Notice that FSK hasn't Spreading Factor parameter, "));
  ...
  else
  {
	  ...
	  {
		  #if (SX1272_debug_mode > 1)
		      USB.print(F("** There has been an error while setting the spreading factor **"));
		      USB.println();
		  #endif
	  }
  }
...
int8_t	WaspSX1272::getBW()
{
  ...
  if( _modem == FSK )
  {
	  ...
	  #if (SX1272_debug_mode > 1)
		  USB.println(F("** FSK mode hasn't bandwidth **"));
		  USB.println();
	  #endif
  }
  else
  {
	  ...
	  else
	  {
		  state = 1;
		  #if (SX1272_debug_mode > 1)
			  USB.print(F("** There has been an error while getting bandwidth **"));
			  USB.println();
		  #endif
	  }
  }
...
int8_t	WaspSX1272::setBW(uint16_t band)
{
  ...
  {
	  #if (SX1272_debug_mode > 1)
		  USB.print(F("## Notice that FSK hasn't Bandwidth parameter, "));
		  USB.println(F("so you are configuring it in LoRa mode ##"));
	  #endif
	  state = setLORA();
  }
...
int8_t	WaspSX1272::getCR()
{
  ...
  if( _modem == FSK )
  {
	  ...
	  #if (SX1272_debug_mode > 1)
		  USB.println(F("** FSK mode hasn't coding rate **"));
		  USB.println();
	  #endif
  }
  else
...
int8_t	WaspSX1272::setCR(uint8_t cod)
{
  ...
  {
	  #if (SX1272_debug_mode > 1)
		  USB.print(F("## Notice that FSK hasn't Coding Rate parameter, "));
		  USB.println(F("so you are configuring it in LoRa mode ##"));
	  #endif
	  state = setLORA();
  }
  ...
  else
  {
	  state = 1;
	  #if (SX1272_debug_mode > 1)
		  USB.println(F("** There has been an error while configuring Coding Rate parameter **"));
		  USB.println();
	  #endif
  }
  writeRegister(REG_OP_MODE,st0);	// Getting back to previous status
...
boolean	WaspSX1272::isChannel(uint32_t ch)
{
  #if (SX1272_debug_mode > 1)
	  USB.println();
	  USB.println(F("Starting 'isChannel'"));
  #endif
  ...
  #if (SX1272_debug_mode > 1)
	  USB.println(F("## Finished 'isChannel' ##"));
	  USB.println();
  #endif
}
...
uint8_t WaspSX1272::getChannel()
{
  ...
  #if (SX1272_debug_mode > 1)
	  USB.println();
	  USB.println(F("Starting 'getChannel'"));
  #endif
  ...
  if( (_channel == ch) && isChannel(_channel) )
  {
	  state = 0;
	  #if (SX1272_debug_mode > 1)
		  USB.print(F("## Frequency channel is "));
...
int8_t WaspSX1272::setChannel(uint32_t ch)
{
  ...
  #if (SX1272_debug_mode > 1)
	  USB.println();
	  USB.println(F("Starting 'setChannel'"));
  #endif
...
/*
	Function: Change Channel during frequency hopping
	ch: frequency channel value to set in configuration.
*/
int8_t WaspSX1272::changeChannel(uint32_t ch)
{
  unsigned int freq3;
  unsigned int freq2;
  uint8_t freq1;
...
uint8_t WaspSX1272::getPower()
{
  ...
  #if (SX1272_debug_mode > 1)
	  USB.println();
	  USB.println(F("Starting 'getPower'"));
  #endif
...
int8_t WaspSX1272::setPower(char p)
{
  ...
  #if (SX1272_debug_mode > 1)
	  USB.println();
	  USB.println(F("Starting 'setPower'"));
  #endif
  ...
  if( value == _power )
  {
	  state = 0;
	  #if (SX1272_debug_mode > 1)
		  USB.println(F("## Output power has been successfully set ##"));
		  USB.println();
	  #endif
  }
  else
...
int8_t WaspSX1272::setPowerNum(uint8_t pow)
{
  ...
  else
  {
	  state = -1;
	  #if (SX1272_debug_mode > 1)
		  USB.println(F("## Power value is not valid ##"));
		  USB.println();
	  #endif
  }
...
uint8_t WaspSX1272::getPreambleLength()
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'getPreambleLength'"));
	#endif
	...
	if( _modem == LORA )
  	{ // LORA mode
		...
		#if (SX1272_debug_mode > 1)
			USB.print(F("## Preamble length configured is "));
...
uint8_t WaspSX1272::setPreambleLength(uint16_t l)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'setPreambleLength'"));
	#endif
...
uint8_t WaspSX1272::getPayloadLength()
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'getPayloadLength'"));
	#endif
	...
	#if (SX1272_debug_mode > 1)
		USB.print(F("## Payload length configured is "));
...
int8_t WaspSX1272::setPacketLength(uint8_t l)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'setPacketLength'"));
	#endif
...
uint8_t WaspSX1272::getNodeAddress()
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'getNodeAddress'"));
	#endif
...
{	// getSNR exists only in LoRa mode
  ...
  { // forbidden command if FSK mode
	state = -1;
	#if (SX1272_debug_mode > 0)
		USB.println(F("** SNR does not exist in FSK mode **"));
		USB.println();
	#endif
  }
  return state;
...
uint8_t WaspSX1272::getRSSI()
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'getRSSI'"));
	#endif
...
{	// RSSIpacket only exists in LoRa
  ...
  #if (SX1272_debug_mode > 1)
	  USB.println();
	  USB.println(F("Starting 'getRSSIpacket'"));
  #endif
  ...
  { // LoRa mode
	  ...
	  #if (SX1272_debug_mode > 0)
		  USB.print(F("## RSSI packet value is "));
  ...
  { // RSSI packet doesn't exist in FSK mode
	state = -1;
	#if (SX1272_debug_mode > 0)
		USB.println(F("** RSSI packet does not exist in FSK mode **"));
		USB.println();
	#endif
  }
  return state;
...
uint8_t WaspSX1272::setRetries(uint8_t ret)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'setRetries'"));
	#endif
	...
	if( ret > MAX_RETRIES )
	{
		state = -1;
		#if (SX1272_debug_mode > 1)
			USB.print(F("** Retries value can't be greater than "));
	...
	else
	{
		...
		state = 0;
		#if (SX1272_debug_mode > 1)
			USB.print(F("## Maximum retries value = "));
...
uint8_t WaspSX1272::getMaxCurrent()
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'getMaxCurrent'"));
	#endif
	...
	_maxCurrent = value;
	#if (SX1272_debug_mode > 1)
		USB.print(F("## Maximum current supply configured is "));
		USB.print(value, DEC);
		USB.println(F(" mA ##"));
		USB.println();
	#endif
...
int8_t WaspSX1272::setMaxCurrent(uint8_t rate)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'setMaxCurrent'"));
	#endif
	...
	if (rate > 0x1B)
	{
		state = -1;
		#if (SX1272_debug_mode > 1)
			USB.print(F("** Maximum current supply is 240 mA, "));
...
uint8_t WaspSX1272::getRegs()
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'getRegs'"));
	#endif
	...
	else
	{
		state_f = 1;
		#if (SX1272_debug_mode > 1)
			USB.println(F("** Error getting mode **"));
		#endif
	}
 	if( state == 0 )
	{
	...
	else
	{
		state_f = 1;
		#if (SX1272_debug_mode > 1)
			USB.println(F("** Error getting power **"));
		#endif
	}
	if( state == 0 )
	{
	...
	else
	{
		state_f = 1;
		#if (SX1272_debug_mode > 1)
			USB.println(F("** Error getting channel **"));
		#endif
	}
	if( state == 0 )
	{
	...
	else
	{
		state_f = 1;
		#if (SX1272_debug_mode > 1)
			USB.println(F("** Error getting CRC **"));
		#endif
	}
	if( state == 0 )
	{
	...
	else
	{
		state_f = 1;
		#if (SX1272_debug_mode > 1)
			USB.println(F("** Error getting header **"));
		#endif
	}
	if( state == 0 )
	{
	...
	else
	{
		state_f = 1;
		#if (SX1272_debug_mode > 1)
			USB.println(F("** Error getting preamble length **"));
		#endif
	}
	if( state == 0 )
	{
	...
	else
	{
		state_f = 1;
		#if (SX1272_debug_mode > 1)
			USB.println(F("** Error getting payload length **"));
		#endif
	}
	if( state == 0 )
	{
	...
	else
	{
		state_f = 1;
		#if (SX1272_debug_mode > 1)
			USB.println(F("** Error getting node address **"));
		#endif
	}
	if( state == 0 )
	{
...
uint8_t WaspSX1272::truncPayload(uint16_t length16)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'truncPayload'"));
	#endif
...
uint8_t WaspSX1272::receive()
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'receive'"));
	#endif
	...
	{ 
		...
		#if (SX1272_debug_mode > 1)
			USB.println(F("## Receiving LoRa mode activated with success ##"));
			USB.println(millis());
		#endif
	}
	else
	{ 
		...
		#if (SX1272_debug_mode > 1)
			USB.println(F("## Receiving FSK mode activated with success ##"));
			USB.println();
		#endif
	}
...
uint8_t WaspSX1272::receivePacketTimeout(uint32_t wait)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'receivePacketTimeout'"));
	#endif
...
uint8_t WaspSX1272::receivePacketTimeoutACK(uint32_t wait)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'receivePacketTimeoutACK'"));
	#endif
	...
	if( (state == 0) || (state == 3) )
	{
		...
		if( state == 0 )
		{
			...
			state_f = 0;
			#if (SX1272_debug_mode > 1)
				USB.println(F("This last packet was an ACK, so ..."));
				USB.println(F("ACK successfully sent"));
				USB.println();
			#endif
			}
			else
...
uint8_t WaspSX1272::receiveAll(uint32_t wait)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'receiveAll'"));
	#endif
	...
	#if (SX1272_debug_mode > 1)
		USB.println(F("## Address filtering desactivated ##"));
		USB.println();
	#endif
...
boolean	WaspSX1272::availableData(uint32_t wait)
{
	...
	#if (SX1272_debug_mode > 0)
		USB.println();
		USB.println(F("Starting 'availableData'"));
	#endif
	...
	{ 
		...
		{
			#if (SX1272_debug_mode > 0)
				USB.println(F("## Valid Header received in LoRa mode ##"));
			#endif
			_hreceived = true;
		...
		else
		{
			...
			_hreceived = false;
			#if (SX1272_debug_mode > 0)
				USB.println(F("** The timeout has expired **"));
				USB.println();
			#endif
		}
	}
	else
	{
		...
		if( bitRead(value, 2) == 1 )	// something received
		{
			_hreceived = true;
			#if (SX1272_debug_mode > 0)
				USB.println(F("## Valid Preamble detected in FSK mode ##"));
			#endif
	...
	{ 
		...
		{ // LoRa or FSK mode
			forme = true;
			#if (SX1272_debug_mode > 0)
				USB.println(F("## Packet received is for me ##"));
			#endif
		}
		else
		{
...
int8_t WaspSX1272::getPacket(uint32_t wait)
{
	...
	#if (SX1272_debug_mode > 0)
		USB.println();
		USB.println(F("Starting 'getPacket'"));
	#endif
	...
	if( _modem == LORA )
	{
		...
		// read REG_IRQ_FLAGS
		value = readRegister(REG_IRQ_FLAGS);
		writeRegister(REG_HOP_PERIOD,1);
		...
		while( (bitRead(value, 6) == 0) && (millis()-previous < (unsigned long)wait) )
		{
			...
			if(bitRead(value,1) == 1) 
			{
				...
				hop = readRegister(REG_HOP_CHANNEL);	
				changeChannel(HoppingFrequencies[hop%2]);	
			//	changeChannel(0xD84CCC);					
		...
		{ 
			...
			_reception = CORRECT_PACKET;
			#if (SX1272_debug_mode > 0)
				USB.println(F("## Packet correctly received in LoRa mode ##"));
			#endif
		}
		else
		{
			...
			{ 
				...
				state = 3;
				#if (SX1272_debug_mode > 0)
					USB.println(F("** The CRC is incorrect **"));
					USB.println();
				#endif
			}
		}			
	...
	{ 
		...
		{ // packet received
			...
			{ // CRC correct
				...
				p_received = true;
				#if (SX1272_debug_mode > 0)
					USB.println(F("## Packet correctly received in FSK mode ##"));
				#endif
			}
			else
			{ // CRC incorrect
				...
				p_received = false;
				#if (SX1272_debug_mode > 0)
					USB.println(F("## Packet incorrectly received in FSK mode ##"));
				#endif
			}
		}
		else
	...
	{		
		...
		{
			#if (SX1272_debug_mode > 0)
				USB.println(F("Corrupted packet, length must be less than 256"));
			#endif
		}
		else
		{
	...
	else
	{
		...
		if( (_reception == INCORRECT_PACKET) && (_retries < _maxRetries) && (state != 3) )
		{
			_retries++;
			#if (SX1272_debug_mode > 0)
				USB.println(F("## Retrying to send the last packet ##"));
				USB.println();
			#endif
		}
	}
	...
	if( wait > MAX_WAIT )
	{
		state_f = -1;
		#if (SX1272_debug_mode > 0)
			USB.println(F("** The timeout must be smaller than 12.5 seconds **"));
			USB.println();
		#endif
	}
...
int8_t WaspSX1272::setDestination(uint8_t dest)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'setDestination'"));
	#endif
...
uint8_t WaspSX1272::setTimeout()
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'setTimeout'"));
	#endif
...
uint8_t WaspSX1272::setPayload(char *payload)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'setPayload'"));
	#endif
	...
	if( ( _modem == FSK ) && ( _payloadlength > MAX_PAYLOAD_FSK ) )
	{
		...
		state = 1;
		#if (SX1272_debug_mode > 1)
			USB.println(F("In FSK, payload length must be less than 60 bytes."));
			USB.println();
		#endif
	}
...
uint8_t WaspSX1272::setPacket(uint8_t dest, char *payload)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'setPacket'"));
	#endif
	...
	else
	{
		...
		packet_sent.retry = _retries;
		#if (SX1272_debug_mode > 0)
			USB.print(F("** Retrying to send last packet "));
	...
	if( state == 0 )
	{
		...
		state = 0;
		#if (SX1272_debug_mode > 0)
			USB.println(F("## Packet set and written in FIFO ##"));
			// Print the complete packet if debug_mode
			USB.print(F("## Packet to send: "));
...
uint8_t WaspSX1272::sendPacketTimeout(uint8_t dest, char *payload)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'sendPacketTimeout'"));
	#endif
...
uint8_t WaspSX1272::sendPacketTimeoutACKRetries(uint8_t dest, char *payload)
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'sendPacketTimeoutACKRetries'"));
	#endif
...
uint8_t WaspSX1272::getTemp()
{
	...
	#if (SX1272_debug_mode > 1)
		USB.println();
		USB.println(F("Starting 'getTemp'"));
	#endif
...
uint8_t WaspSX1272::setRTCfromMeshlium()
{
	...
	{
		#if (SX1272_debug_mode > 1)  
			USB.println(F("packet sent ERROR"));
		#endif 
		return 1;
	}
	...
	if( status == 0 )
	{
		...
		{
			#if (SX1272_debug_mode > 1) 
				USB.println(F("ERROR: buffer not enough for length"));      
				USB.print(F("length:"));
	...
	{
		#if (SX1272_debug_mode > 1) 
			USB.print(F("Receiving packet TIMEOUT, state "));
