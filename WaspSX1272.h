...
const int32_t HoppingFrequencies[] =
{
	...
	0xD84CCC, // channel 10, central freq = 865.20MHz
	...
	0xD90000, // channel 16, central freq = 868.00MHz
	0xE1C51E, // channel 00, central freq = 903.08MHz
	0xE24F5C, // channel 01, central freq = 905.24MHz
	0xE2D999, // channel 02, central freq = 907.40MHz
	0xE363D7, // channel 03, central freq = 909.56MHz
	0xE3EE14, // channel 04, central freq = 911.72MHz
	0xE47851, // channel 05, central freq = 913.88MHz
	0xE5028F, // channel 06, central freq = 916.04MHz
	0xE58CCC, // channel 07, central freq = 918.20MHz
	0xE6170A, // channel 08, central freq = 920.36MHz
	0xE6A147, // channel 09, central freq = 922.52MHz
	0xE72B85, // channel 10, central freq = 924.68MHz
	0xE7B5C2, // channel 11, central freq = 926.84MHz
//	0xE4C000, // default channel 915MHz
...
//! WaspSX1272 Class
/*!
	WaspSX1272 Class defines all the variables and functions used to manage
...
public:
	...
	byte readRegisterValue(byte address);
	...
	int8_t changeChannel(uint32_t ch);
